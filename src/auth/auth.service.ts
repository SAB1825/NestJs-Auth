...
export class AuthServive {
  ...
  async login(dto: LoginDto): Promise<AuthResult> {
    ...
    if (!user || !user.passwordHash) {
      throw new UnauthorizedException('The give email doesnt exist ');
    }
  ...
  async loginWithOAuthProfile(profile: {
    ...
    let user = profile.googleId ? await this.usersService.findByGoogleId(profile.googleId) : undefined;
